...
export function fetchMerge(args = {}) {
  return (dispatch) => { // optionally you can have getState as the second argument
    ...
    const promise = new Promise((resolve, reject) => {
      ...
      doRequest.then(
        (res) => {
          dispatch({
            type: UPLOAD_FILE_FETCH_MERGE_SUCCESS,
            data: res,
          });
          resolve(res);
        },
        ...
        (err) => {
          dispatch({
            type: UPLOAD_FILE_FETCH_MERGE_FAILURE,
            data: { error: err },
          });
          reject(err);
        },
...
export function reducer(state, action) {
  switch (action.type) {
    case UPLOAD_FILE_FETCH_MERGE_BEGIN:
    ...
    case UPLOAD_FILE_FETCH_MERGE_SUCCESS:
    ...
    case UPLOAD_FILE_FETCH_MERGE_FAILURE:
    ...
    case UPLOAD_FILE_FETCH_MERGE_DISMISS_ERROR:
